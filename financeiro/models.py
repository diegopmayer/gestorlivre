...
class Categoria_registro(models.Model):
    ...
    Nome_da_categoria = models.CharField(max_length=100, null=True, blank=True)
    def _str_(self):
...
class Registro_financeiro(models.Model):
    ...
    Fornecedor_do_registro = models.ForeignKey(
            Fornecedor, on_delete=models.CASCADE, 
            null=True, 
            blank=True)
    ...
    Produto_do_registro = models.ForeignKey(
            Produto, 
            on_delete=models.CASCADE, 
            null=True, 
            blank=True)
    ...
    Obs_do_registro = models.TextField(null=True, blank=True)

    Data_do_registro = models.DateField(null=True, blank=True)